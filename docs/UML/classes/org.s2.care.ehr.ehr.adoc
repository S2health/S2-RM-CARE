...
h|*0..1*
|*state*: `List<link:/releases/BASE/{base_release}/base_types.html#_object_ref_class[Object_ref^]>`
...
h|*0..1*
|*events*: `List<link:/releases/BASE/{base_release}/base_types.html#_object_ref_class[Object_ref^]>`
a|Master list of all Versioned Composition references in this EHR.

h|*0..1*
|*plans*: `List<link:/releases/BASE/{base_release}/base_types.html#_object_ref_class[Object_ref^]>`
a|Master list of all Versioned Composition references in this EHR.
