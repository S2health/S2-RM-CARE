...
h|*1..1*
|*is_queryable*: `link:/releases/S2-RM-BASE/{base_release}/docs/foundation_types.html#_boolean_class[Boolean^]`
a|True if this EHR should be included in population queries, i.e. if this EHR is considered active in the population.

h|*1..1*
|*is_modifiable*: `link:/releases/S2-RM-BASE/{base_release}/docs/foundation_types.html#_boolean_class[Boolean^]`
