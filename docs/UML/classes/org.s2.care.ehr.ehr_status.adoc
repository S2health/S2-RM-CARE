...
h|*1..1*
|*subject*: `link:/releases/BASE/{base_release}/patterns.html#_party_self_class[Party_self^]`
...
h|*0..1*
|*other_details*: `List<link:/releases/BASE/{base_release}/patterns.html#_item_class[Item^]>`
