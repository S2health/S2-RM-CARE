...
h|*1..1*
|*territory*: `link:/releases/S2-RM-BASE/{base_release}/docs/foundation_types.html#_terminology_code_class[Terminology_code^]`
...
h|*1..1*
|*category*: `link:/releases/S2-RM-BASE/{base_release}/docs/data_types.html#_coded_text_class[Coded_text^]`
...
h|*1..1*
|*author*: `link:/releases/S2-RM-BASE/{base_release}/docs/patterns.html#_entity_ref_node_class[Entity_ref_node^]`
