...
h|*0..1*
|*other_participations*: `List<link:/releases/BASE/{base_release}/patterns.html#_participation_class[Participation^]>`
...
h|*0..1*
|*reporter*: `link:/releases/BASE/{base_release}/patterns.html#_party_proxy_class[Party_proxy^]`
...
h|*0..1*
|*authorization_actions*: `List<link:/releases/BASE/{base_release}/patterns.html#_participation_class[Participation^]>`
