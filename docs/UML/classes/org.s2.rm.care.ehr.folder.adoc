...
h|*0..1*
|*items*: `List<link:/releases/S2-RM-BASE/{base_release}/docs/model_support.html#_object_ref_class[Object_ref^]>`
...
h|*0..1*
|*details*: `link:/releases/S2-RM-BASE/{base_release}/docs/patterns.html#_node_class[Node^]`
