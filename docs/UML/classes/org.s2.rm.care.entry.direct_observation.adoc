...
h|*0..1*
|*state_series*: `List<link:/releases/S2-RM-BASE/{base_release}/docs/patterns.html#_event_class[Event^]>`
...
h|*0..1*
|*data_series*: `List<link:/releases/S2-RM-BASE/{base_release}/docs/patterns.html#_event_class[Event^]>`
