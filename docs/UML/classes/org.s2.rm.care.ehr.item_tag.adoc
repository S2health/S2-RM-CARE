...
h|*1..1*
|*key*: `link:/releases/S2-RM-BASE/{base_release}/docs/foundation_types.html#_string_class[String^]`
a|The tag key. May not be empty or contain leading or trailing whitespace.

h|*0..1*
|*value*: `link:/releases/S2-RM-BASE/{base_release}/docs/foundation_types.html#_string_class[String^]`
a|The value. If set, may not be empty.

h|*1..1*
|*target*: `link:/releases/S2-RM-BASE/{base_release}/docs/model_support.html#_object_id_class[Object_id^]`
a|Identifier of target, which may be a `VERSIONED_OBJECT<T>` or a `VERSION<T>`.

h|*0..1*
|*target_path*: `link:/releases/S2-RM-BASE/{base_release}/docs/foundation_types.html#_string_class[String^]`
a|Optional archetype (i.e. AQL) or RM path within `_target_`, used to tag a fine-grained element.

h|*1..1*
|*owner_id*: `link:/releases/S2-RM-BASE/{base_release}/docs/model_support.html#_object_ref_class[Object_ref^]`
