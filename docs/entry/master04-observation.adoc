...
include::{uml_export_dir}/classes/{pkg}measured_observation.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}adhoc_observation.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}real_time_observation.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}interpreted_observation.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}scored_observation.adoc[leveloffset=+1]
